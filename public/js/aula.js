...
$(document).on("click", ".infoModal", function () {
 ...
 $.ajax({
  ...
  success: function (data) {
   ...
   var row =
    '<tr><td width="30%"> Nombre: </td><td width="70%">' +
    data.nombre +
    "</td>";
   row += "<tr><td> Capacidad: </td><td>" + data.capacidad + "</td>";
