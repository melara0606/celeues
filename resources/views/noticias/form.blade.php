...
<body>
    ...
    {{--    --}}              <!--Page Title-->
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Noticias</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content" >
					...
					<div class="row ">
					 ...
					 <div class="bord-all">
					            ...
					            <!-- BASIC FORM ELEMENTS -->
					            <!--===================================================-->
					            <form class="panel-body form-horizontal form-padding" action="noticiaForm/create" method="post">
                                    ...
                                    <div class="form-group">
                                     <div class="col-md-10 ui-panels form-group">
                                        <div class=" text-right">
                                            <button class="btn btn-primary" type="summit">Nuevo</button>
                                        </div>
                                     </div>
                                 </div>
