  ...
  <div class="panel" >
   ...
   {{-- <div class="row">
    ...
    <div  id="nombrediv" class="form-group @if($errors->has('nombre')) has-danger @endif" >
        <label for="example-text-input" class="col-md-3 control-label text-main text-bold "> Aula: *</label>
        <div class="col-md-7 " >
            ...
            <input class="form-control" type="text" placeholder="Ingrese el nombre del aula" id="nombre" name="nombre">
    ...
    <div id="capacidaddiv" class="form-group">
        <label for="example-number-input" class="col-md-3 control-label text-main text-bold ">Capacidad:*</label>
        <div class="col-md-7  ">
          <input class="form-control" type="text" placeholder="ingrese el numero de personas" id="capacidad" name="capacidad">
          <div id="capacidadfeed" class="form-control-feedback"></div>
        </div>
    </div>
